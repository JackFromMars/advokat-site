...
export default function Map() {
  return (
    <section id="contacts" className="section-glow py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold mt-4 mb-6">
            Як мене <span className="gold-gradient">знайти</span>
          </h2>
          <a
            href={contacts.googleMapsUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="text-[var(--color-foreground-secondary)] hover:text-[var(--color-accent)] text-sm tracking-wide"
            style={{
